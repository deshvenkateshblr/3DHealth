...
window.EXERCISES = [
  ...
  // 1
  {
    ...
    "extended_info": "Think of this as a gentle massage for your spine. By slowly arching and rounding your back in rhythm with your breath, you pump fluid into the spinal discs and release the 'hunched' tension that builds up from staring at screens all day.",
    "video_url": "https://www.youtube.com/watch?v=YCJ498mYxWs", // Source: Siddhi Yoga
  ...
  // 2
  {
    ...
    "extended_info": "A perfect starting point if floor push-ups feel too heavy on your wrists or shoulders. It builds the chest and core strength you need for everyday pushing movements, like opening heavy doors, without joint strain.",
    "video_url": "https://www.youtube.com/watch?v=w-yZiHFt6SA", // Source: Saurabh Bothra
  ...
  // 3
  {
    ...
    "extended_info": "When we sit all day, our glute (butt) muscles essentially 'go to sleep.' This move wakes them up. Strong glutes act like powerful shock absorbers for your knees and lower back every time you take a step.",
    "video_url": "https://www.youtube.com/watch?v=nRwkgZZ55_A", // Source: Ayush CYP
  ...
  // 4
  {
    ...
    "extended_info": "Our feet contain dozens of tiny muscles that rarely get a workout in modern shoes. Stretching the calves and using your toes to pull a towel rebuilds the foot arch, which is foundational for relieving calf tightness and plantar fasciitis.",
    "video_url": "https://www.youtube.com/watch?v=CPF1nTrrQSg", // Source: Saurabh Bothra
  ...
  // 5
  {
    ...
    "extended_info": "Inhale for 4 seconds, hold for 4, exhale for 4, hold empty for 4. This specific rhythm acts like a manual override switch for your nervous system, instantly lowering your heart rate and cutting through mental fog.",
    "video_url": "https://www.youtube.com/watch?v=8TTABLdGCKI", // Source: Saurabh Bothra
  ...
  // 6
  {
    ...
    "extended_info": "Gravity pulls blood and lymphatic fluid down into our legs all day. Elevating them against a wall passively drains this fluid back toward the heart, instantly reducing ankle swelling and deeply resting the cardiovascular system.",
    "video_url": "https://www.youtube.com/watch?v=TzahhHZvOks", // Source: Siddhi Yoga
  ...
  // 7
  {
    ...
    "extended_info": "For every inch your head tilts forward to look at a screen, it adds 10 pounds of pressure to your neck. A chin tuck (pulling your head straight back, making a 'double chin') resets this alignment and immediately relieves neck tension.",
    "video_url": "https://www.youtube.com/watch?v=3ctIwvT823s", // Source: Bob & Brad (PT)
    ...
    // 8
  {
    ...
    "extended_info": "Lying on your back and dropping your knees to one side acts like wringing out a wet towel. It relieves tightness in the lower back muscles while the gentle compression helps move trapped gas through the digestive tract.",
    "video_url": "https://www.youtube.com/watch?v=3qUuzZUck7I", // Source: Siddhi Yoga
   ...
   // 9
  {
    ...
    "extended_info": "Unlike sit-ups, which only work the outer muscles, TvA breathing engages the deepest layer of your core. By exhaling and drawing your belly button toward your spine, you build a natural 'corset' that protects your lower back and pelvic floor.",
    "video_url": "https://www.youtube.com/watch?v=Ielt7Mj-F_I", // Source: CCGI (Clinical PT)
  ...
  // 11
  {
    "exercise": "Low-Intensity Steady State Walk",
    "aka": "LISS Cardio",
  ...
  // 16
  {
    ...
    "extended_info": "Gently pulling your fingers back, and then pointing them down. It releases the tight forearm tendons caused by endless typing and texting, which helps prevent carpal tunnel and repetitive strain injuries.",
    "video_url": "https://www.youtube.com/watch?v=qRvBbzvxfd4", // Source: Saurabh Bothra
    "video_search_term": "",
  ...
  // 17
  {
    ...
    "extended_info": "On all fours, extending your opposite arm and leg. It trains your core to keep your spine perfectly stable while your limbs move—this is the exact core function needed to prevent lower back injuries in daily life.",
    "video_url": "https://www.youtube.com/watch?v=GPovf3hFEEk", // Source: Saurabh Bothra
    "video_search_term": "",
  ...
  // 19
  {
    ...
    "extended_info": "Moving your foot up and down at the ankle. This simple movement acts like a manual pump for your 'second heart' (your calf muscles), physically pushing pooled blood and fluid from your lower legs back up to your heart.",
    "video_url": "https://www.youtube.com/watch?v=CPF1nTrrQSg", // Source: Saurabh Bothra
    "video_search_term": "",
  ...
  // 20
  {
    ...
    "extended_info": "Practicing standing on one leg while lightly holding a chair. Physical balance degrades quickly as we age if we don't use it. This simple drill reinforces the brain-body connection required to prevent falls.",
    "video_url": "https://www.youtube.com/watch?v=obP26s-h4Bc", // Source: Saurabh Bothra
    "video_search_term": "",
    ...
    // 22
  {
    ...
    "extended_info": "Gently tilting your ear toward your shoulder. The 'traps' are the muscles where we physically hold our emotional stress. Stretching them releases tension headaches and prevents your shoulders from creeping up to your ears.",
  ...
  // 23
  {
    ...
    "extended_info": "Breathing deep into your belly rather than shallowly into your chest. This physically pushes on the vagus nerve, sending a biological signal to your brain to immediately lower your blood pressure and stop producing stress hormones.",
    "video_url": "https://www.youtube.com/watch?v=OtHPzU0-t2Y", // Source: Saurabh Bothra (12-Min Breathing)
    "video_search_term": "",
    ...
    // 25
  {
    ...
    "extended_info": "Squeezing the muscles you would use to stop the flow of urine. It acts like a hammock holding up your pelvic organs. Strengthening it prevents leaks when you sneeze or laugh, and speeds up postpartum recovery.",
    "video_url": "https://www.youtube.com/watch?v=7z3dIupRStI", // Source: Saurabh Bothra (Kegel Exercises)
    "video_search_term": "",
  ...
  // 26
  {
    ...
    "extended_info": "Crossing one ankle over the opposite knee while seated. It targets the piriformis muscle deep in your hip. When this gets tight from sitting, it pinches the sciatic nerve, causing that sharp, shooting pain down your leg.",
    "video_url": "https://www.youtube.com/watch?v=KFzXh11pdCc", // Source: Saurabh Bothra (Chair Yoga)
    "video_search_term": "",
  ...
  // 27
  {
    ...
    "equipment": "Chair",
    "note": "Gently massages abdominal organs to stimulate digestion and relieve lower back tightness.",
    "extended_info": "Sitting tall and twisting to look over your shoulder. It relieves tightness in the lower back muscles while the gentle compression helps move trapped gas through the digestive tract without needing to get on the floor.",
    "video_url": "https://www.youtube.com/watch?v=6P4tCTbXky0", // Source: Ayush CYP (Vakrasana)
    "video_search_term": "",
    "symptoms": ["Constipation", "Bloating", "Irritable Bowel Syndrome", "Indigestion", "Back Pain"],
    "contraindications": ["Pregnancy Discomfort", "Recent Surgery / Injury", "Hernia"]
  },
   ...
   // 29
  {
    ...
    "extended_info": "Lying on your back with knees bent, you gently flatten your lower back against the floor and release. It creates tiny, safe movements in the lower spine that relieve the aching pressure of standing or carrying extra weight.",
    "video_url": "https://www.youtube.com/watch?v=GPovf3hFEEk", // Source: Saurabh Bothra (Core & Back)
    "video_search_term": "",
  ...
  // 31
  {
    ...
    "extended_info": "This focuses on slow, gentle, flowing movements that safely train the nervous system to handle weight shifts. It is highly effective for building joint resilience and is a clinically proven method for preventing falls in seniors.",
    "video_url": "",
    "video_search_term": "Tai chi weight shifting for seniors Bob and Brad",
  ...
  // 32
  {
    ...
    "extended_info": "The buoyancy of the water supports your body weight, making it the perfect environment to move vigorously and get your heart rate up without causing impact stress to painful knees, hips, or the lower back.",
    "video_url": "",
    "video_search_term": "Water aerobics exercises for bad knees",
  ...
  // 38
  {
    "exercise": "Seated Neck Stretches",
    "aka": "Greeva Sanchalana",
    "profile": "Low Risk",
    "movement_type": "Tension Relief",
    "gender": "All",
    "age": "All",
  ...
  // 43
  {
    ...
    "extended_info": "Unstructured outdoor walking without tracking metrics. Being in green spaces and moving at a relaxed pace has been proven to significantly lower cortisol, reduce anxiety, and improve overall mood and circadian rhythm.",
    "video_url": "",
    "video_search_term": "Benefits of walking outside Bob and Brad",
  ...
  {
    "exercise": "Supported Downward Dog (Hands on Wall/Chair)",
    "aka": "Adho Mukha Svanasana Variation",
    "profile": "Low Risk",
    "movement_type": "Gentle Decompression",
    "gender": "All",
    "age": "All",
  ...
  // 54
  {
    "exercise": "Gentle Seated Forward Fold",
  ...
  // 64
  {
    ...
    "extended_info": "Using your fingertips to gently massage the thick masseter muscles at the hinges of your jaw. We unknowingly clench these powerful muscles when stressed; releasing them reduces nighttime teeth grinding and relieves stubborn tension headaches.",
    "video_url": "",
    "video_search_term": "Masseter massage jaw release Bob and Brad",
  ...
  // 68
  {
    ...
    "extended_info": "Tapping one foot out to the side while raising your arms, alternating sides instead of jumping. It provides the exact same cardiovascular and metabolic benefits of a traditional jumping jack without the jarring, painful impact on your knees and ankles.",
    "video_url": "",
    "video_search_term": "Low impact step jacks cardio Bob and Brad",
  ...
  // 69
  {
    ...
    "aka": "Ashta Chandrasana Variation",
    "profile": "Metabolic;Age Specific",
    ...
    // 72
  {
    ...
    "extended_info": "Lying on your back with your calves resting on the seat of a chair. This specific 90/90 angle completely offloads the psoas muscle (a deep hip flexor that holds stress), instantly signaling physical safety to your nervous system and lowering cortisol.",
    "video_url": "",
    "video_search_term": "Constructive rest position psoas release Bob and Brad",
  ...
  // 73
  {
    ...
    "extended_info": "Inhaling deeply and exhaling forcefully through the mouth while sticking the tongue out and opening the eyes wide. It looks silly, but it is a powerful physical release valve that relieves intense facial and chest tension associated with chronic stress and anxiety.",
    "video_url": "",
    "video_search_term": "Lion's breath Simhasana yoga",
  ...
  // 78
  {
    "exercise": "Sufi Grinds",
    "aka": "Seated Torso Circles",
    "profile": "Low Risk",
  ...
  // 81
  {
    ...
    "aka": "Knocking on the Door of Life",
    "profile": "Low Risk",
  ...
  // 83
  {
    "exercise": "Modified Chair Sun Salutation",
    "aka": "Chair Surya Namaskar",
    "profile": "Cardiometabolic;Age Specific",
